...
<head>
    ...
    <title>Proforma - {$d['invoicenum']}{if $d['cn'] neq ''} {$d['cn']} {else} {$d['id']} {/if}</title>
			...
			<div class="invoice">
				...
				<header class="clearfix">
					...
					<div class="bill-info">
						<div class="row">
							<div class="col-md-6">
								<h2> Proforma Total: {ib_money_format($d['subtotal'],$_c,$d['currency_symbol'])} </h2>
							...
							<div class="col-md-6">
								<div class="bill-data text-right">
									...
									<form class="form-inline" method="post" action="{$_url}client/proformaipay/{$d['id']}/token_{$d['vtoken']}">
										<input type="hidden" name="amount" value="{$i_due}">
										<input type="hidden" name="firstname" value="{$a['company']}">
										<input type="hidden" name="email" value="{$a['email']}">
										<input type="hidden" name="phone" value="{$a['phone']}">
										<input type="hidden" name="productinfo" value="{$d['invoicenum']}">
										<input type="hidden" name="surl" value="{$_url}client/proformaipay_success">
										<input type="hidden" name="furl" value="{$_url}client/proformaipay_cancel">
