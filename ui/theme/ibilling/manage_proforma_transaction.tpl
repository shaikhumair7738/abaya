    ...
    <div class="col-md-4">
        ...
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-title">
                ...
                <h5>Edit Proforma Transactions - [#{ib_lan_get_line($t['type'])}-{$t['id']}]</h5>
...
{/if}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-offset-3 col-sm-9">
                            ...
                            <button type="submit" id="proforma_submit" class="btn btn-primary"><i class="fa fa-check"></i> {$_L['Submit']}</button>
    ...
    <div class="col-md-8">
        ...
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
                ...
                <form role="form" method="post" action="{$_url}transactions/delete-proforma-post/">
