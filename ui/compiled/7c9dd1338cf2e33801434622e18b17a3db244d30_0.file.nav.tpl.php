<?php
/* Smarty version 3.1.30, created on 2022-06-10 16:41:00
  from "/home3/mbillsin/public_html/alabaya/ui/theme/ibilling/sections/nav.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_62a326c4acf098_03769817',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '7c9dd1338cf2e33801434622e18b17a3db244d30' => 
    array (
      0 => '/home3/mbillsin/public_html/alabaya/ui/theme/ibilling/sections/nav.tpl',
      1 => 1654859454,
      2 => 'file',
    ),
  ),
...
function content_62a326c4acf098_03769817 (Smarty_Internal_Template $_smarty_tpl) {
?>
...
?>
    ...
    <li class="<?php if ($_smarty_tpl->tpl_vars['_application_menu']->value == 'accounts') {?>active<?php }?>">
				<a href="#"><i class="fa fa-building-o"></i> <span class="nav-label"><?php echo $_smarty_tpl->tpl_vars['_L']->value['Companies'];?>
</span><span class="fa arrow"></span></a>
				<ul class="nav nav-second-level">
						<li><a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
accounts/add/">New Company</a></li>

						<li><a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
accounts/list/">List Company</a></li>
						<li><a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
accounts/balances/">Company_Balances</a></li>
...
transactions/list/"><?php echo $_smarty_tpl->tpl_vars['_L']->value['View Transactions'];?>
                    ...
                    <!--<li><a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
transactions/list-proforma/">View Proforma Transactions</a></li>-->
                    <!--<li><a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
generate/balance-sheet/"><?php echo $_smarty_tpl->tpl_vars['_L']->value['Balance Sheet'];?>
        ...
        <?php }?>
    <?php }?>
<!--<li class="<?php if ($_smarty_tpl->tpl_vars['_application_menu']->value == 'domain_n_hosting') {?>active<?php }?>">
                <a href="#"><i class="icon-credit-card-1"></i> <span class="nav-label">Domain and Hosting</span><span class="fa arrow"></span></a>
                <ul class="nav nav-second-level">

                    <?php if ($_smarty_tpl->tpl_vars['_c']->value['domain_n_hosting'] == '1') {?>
                        <li><a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
domain_n_hosting/list/">List Domain and Hosting</a></li>
                        <li><a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
domain_n_hosting/add/">Add Domain and Hosting</a></li>
                    <?php }?>
                </ul>
            </li>-->
    ...
    <?php if (has_access($_smarty_tpl->tpl_vars['user']->value->roleid,'sales')) {?>
        ...
        <?php if (($_smarty_tpl->tpl_vars['_c']->value['invoicing'] == '1') || ($_smarty_tpl->tpl_vars['_c']->value['quotes'] == '1')) {?>
            ...
            <li class="<?php if ($_smarty_tpl->tpl_vars['_application_menu']->value == 'invoices') {?>active<?php }?>">
                ...
                <ul class="nav nav-second-level">
                    <!--<li><a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
sales/add/">Add Sale</a></li>
                    <li><a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
sales/list/">All Sales</a></li>-->
                    <?php if ($_smarty_tpl->tpl_vars['_c']->value['invoicing'] == '1') {?>
                        <li><a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
invoices/list/filter/"><?php echo $_smarty_tpl->tpl_vars['_L']->value['Invoices'];?>
</a></li>
                        <li><a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
invoices/add/"><?php echo $_smarty_tpl->tpl_vars['_L']->value['Add Invoice'];?>
</a></li>

                        <!--<li><a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
invoices/list-proforma/filter/">Proforma</a></li>
...
accounts/balances/"><?php echo $_smarty_tpl->tpl_vars['_L']->value['Account_Balances'];?>
    ...
    <?php if (($_smarty_tpl->tpl_vars['_c']->value['invoicing'] == '1') || ($_smarty_tpl->tpl_vars['_c']->value['quotes'] == '1')) {?>
        <li class="<?php if ($_smarty_tpl->tpl_vars['_application_menu']->value == 'ps') {?>active<?php }?>">
            ...
            <ul class="nav nav-second-level">
                <li><a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
ps/p-new/">Add Product</a></li>
                <li><a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
ps/p-list/">List Product</a></li>
                <!--<li><a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
...
ps/s-new/"><?php echo $_smarty_tpl->tpl_vars['_L']->value['New Service'];?>
    ...
    <?php if (has_access($_smarty_tpl->tpl_vars['user']->value->roleid,'products_n_services')) {?>
    <li class="<?php if ($_smarty_tpl->tpl_vars['_application_menu']->value == 'manage') {?>active<?php }?>">
            <a href="#"><i class="fa fa-cube"></i> <span class="nav-label">Manage Design</span><span class="fa arrow"></span></a>
            <ul class="nav nav-second-level">
                <li><a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
manage/add-design/">Add Design</a></li>
                <li><a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
manage/list-design/">List Design</a></li>
            </ul>
        </li>
        <?php }?>
...
transactions/list/"><?php echo $_smarty_tpl->tpl_vars['_L']->value['All Transactions'];?>
                ...
                <!--<li><a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
reports/gst-reports/">GST Reports</a></li>-->
