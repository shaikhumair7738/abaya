<?php
/* Smarty version 3.1.30, created on 2017-11-20 16:40:21
  from "/home4/arifkhan/public_html/bill/ui/theme/ibilling/dashboard_canvas_ajax.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5a12b81dc74df2_17295671',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '8c3cffcefb57999cef9bc28b48529c7f5cd1b990' => 
    array (
      0 => '/home4/arifkhan/public_html/bill/ui/theme/ibilling/dashboard_canvas_ajax.tpl',
      1 => 1511176065,
      2 => 'file',
    ),
  ),
...
function content_5a12b81dc74df2_17295671 (Smarty_Internal_Template $_smarty_tpl) {
?>
...
"></div>
                ...
                <table class="table table-striped table-bordered" style="margin-top: 26px;">
                    ...
                    <th class="text-right"><?php echo $_smarty_tpl->tpl_vars['_L']->value['Balance'];?>
                        ...
                        <tr>
                            <td><?php echo $_smarty_tpl->tpl_vars['account_name']->value;?>
</td>
                            <td class="text-right"><span class="amount<?php if ($_smarty_tpl->tpl_vars['ds']->value['balance'] < 0) {?> text-red<?php }?>"><?php echo $_smarty_tpl->tpl_vars['net_worth']->value;?>
</span></td>
                        </tr>
...
?>
  ...
  <div class="ibox-content">
                ...
                <div id="invoice_stats" style="display: none;">
								...
								<a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
invoices/followup/" class="btn btn-primary btn-xs pull-right"><i class="fa fa-list"></i> Follow Up Invoices</a>
                <h4>Follow Up</h4>
                ...
                <table class="table table-bordered table-hover">
                    ...
                    <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['followup']->value, 'fp');
if ($_from !== null) {
foreach ($_from as $_smarty_tpl->tpl_vars['fp']->value) {
?>
                        <tr>
                            <td><a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
invoices/view/<?php echo $_smarty_tpl->tpl_vars['fp']->value['id'];?>
/" target="_blank"><?php echo $_smarty_tpl->tpl_vars['fp']->value['invoicenum'];
if ($_smarty_tpl->tpl_vars['fp']->value['cn'] != '') {?> <?php echo $_smarty_tpl->tpl_vars['fp']->value['cn'];?>
 <?php } else { ?> <?php echo $_smarty_tpl->tpl_vars['fp']->value['id'];?>
 <?php }?></a> </td>
                            <td><a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
contacts/view/<?php echo $_smarty_tpl->tpl_vars['fp']->value['userid'];?>
/" target="_blank"><?php echo $_smarty_tpl->tpl_vars['fp']->value['account'];?>
</a> </td>
                            <td><?php echo $_smarty_tpl->tpl_vars['fp']->value['phone'];?>
</td>
                            <td class="amount"><?php echo $_smarty_tpl->tpl_vars['fp']->value['total'];?>
</td>
                            <td><?php echo date($_smarty_tpl->tpl_vars['_c']->value['df'],strtotime($_smarty_tpl->tpl_vars['fp']->value['date']));?>
</td>
                            <td><?php echo date($_smarty_tpl->tpl_vars['_c']->value['df'],strtotime($_smarty_tpl->tpl_vars['fp']->value['duedate']));?>
</td>
                            <td>


                                <?php if ($_smarty_tpl->tpl_vars['fp']->value['status'] == 'Unpaid') {?>
                                    <span class="label label-danger"><?php echo ib_lan_get_line($_smarty_tpl->tpl_vars['fp']->value['status']);?>
</span>
                                <?php } elseif ($_smarty_tpl->tpl_vars['fp']->value['status'] == 'Paid') {?>
                                    <span class="label label-success"><?php echo ib_lan_get_line($_smarty_tpl->tpl_vars['fp']->value['status']);?>
</span>
                                <?php } elseif ($_smarty_tpl->tpl_vars['fp']->value['status'] == 'Partially Paid') {?>
                                    <span class="label label-info"><?php echo ib_lan_get_line($_smarty_tpl->tpl_vars['fp']->value['status']);?>
</span>
                                <?php } elseif ($_smarty_tpl->tpl_vars['fp']->value['status'] == 'Cancelled') {?>
                                    <span class="label"><?php echo ib_lan_get_line($_smarty_tpl->tpl_vars['fp']->value['status']);?>
</span>
                                <?php } else { ?>
                                    <?php echo ib_lan_get_line($_smarty_tpl->tpl_vars['fp']->value['status']);?>
