<?php
/* Smarty version 3.1.30, created on 2023-10-24 19:35:45
  from "/home2/mbillsin/public_html/alabaya/ui/theme/ibilling/invoice-view.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_6537cf39f197f5_02791656',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'de38ad0c64da9e73c23004210e486ee08177c670' => 
    array (
      0 => '/home2/mbillsin/public_html/alabaya/ui/theme/ibilling/invoice-view.tpl',
      1 => 1692703335,
      2 => 'file',
    ),
  ),
...
function content_6537cf39f197f5_02791656 (Smarty_Internal_Template $_smarty_tpl) {
...
invoices/d_status/&s=pending&iid=<?php echo $_smarty_tpl->tpl_vars['d']->value['id'];?>
&mobile=<?php echo $_smarty_tpl->tpl_vars['a']->value['phone'];?>
">Pending</a></li>
								<li><a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
invoices/d_status/&s=processing&iid=<?php echo $_smarty_tpl->tpl_vars['d']->value['id'];?>
&mobile=<?php echo $_smarty_tpl->tpl_vars['a']->value['phone'];?>
">Processing</a></li>
								<li><a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
invoices/d_status/&s=completed&iid=<?php echo $_smarty_tpl->tpl_vars['d']->value['id'];?>
&mobile=<?php echo $_smarty_tpl->tpl_vars['a']->value['phone'];?>
">Completed</a></li>
							</ul>
						</div>-->	
						<button type="button" data-inv-id="<?php echo $_smarty_tpl->tpl_vars['d']->value['id'];?>
" data-phone="<?php echo $_smarty_tpl->tpl_vars['a']->value['phone'];?>
" class="btn  btn-primary btn-sm" id="delivery_status"><i class="fa fa-ellipsis-v"></i> Delivery</button>				
					<div class="btn-group" role="group">
						<button type="button" class="btn  btn-primary btn-sm dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
...
" class="btn btn-warning  btn-sm"><i class="fa fa-pencil"></i> <?php echo $_smarty_tpl->tpl_vars['_L']->value['Edit'];?>
					...
					<div class="btn-group" role="group">
						...
						<ul class="dropdown-menu" role="menu">
							<li><a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
client/ipdf-tailor/<?php echo $_smarty_tpl->tpl_vars['d']->value['id'];?>
/token_<?php echo $_smarty_tpl->tpl_vars['d']->value['vtoken'];?>
...
: <?php echo $_smarty_tpl->tpl_vars['d']->value['account'];?>
											...
											<strong>Customer Name:</strong> <?php echo $_smarty_tpl->tpl_vars['d']->value['account'];?>
 <br>

											<strong>Address:</strong> <?php echo $_smarty_tpl->tpl_vars['a']->value['address'];?>
 <br>
...
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['delivery_status']->value, 'row');
if ($_from !== null) {
foreach ($_from as $_smarty_tpl->tpl_vars['row']->value) {
?>
									<p><?php echo $_smarty_tpl->tpl_vars['z']->value++;?>
. Marked as <?php echo $_smarty_tpl->tpl_vars['row']->value['delivery_status'];?>
 at <?php echo $_smarty_tpl->tpl_vars['row']->value['timestamp'];?>
<br>
										<?php if (!empty($_smarty_tpl->tpl_vars['row']->value['notes'])) {?><b>Notes :</b> <?php echo $_smarty_tpl->tpl_vars['row']->value['notes'];
}?></p><hr style="margin: 10px 0px;">
									<?php
}
}
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl);
...
" alt="Logo">
								...
								<address class="ib mr-xlg pddd_20">
									<strong class="fontsize_16"><?php echo $_smarty_tpl->tpl_vars['comp']->value['account'];?>
</strong><br>
...
:</span>
									    ...
									    <?php if (!empty($_smarty_tpl->tpl_vars['d']->value['updated_at'])) {?> 
											<p class="mb-none">
												<span class="text-dark">Updated At:</span>
												<span class="value"><?php echo date('Y-m-d H:i A',$_smarty_tpl->tpl_vars['d']->value['updated_at']);?>
 </span>
											</p>
										<?php }?>										

									    <?php if (!empty($_smarty_tpl->tpl_vars['d']->value['created_at'])) {?> 
										<p class="mb-none">
											<span class="text-dark">Created At:</span>
											<span class="value"><?php echo date('Y-m-d H:i A',$_smarty_tpl->tpl_vars['d']->value['created_at']);?>
 </span>
								        </p>
									    <?php }?>
...
?>
 ...
 <?php } else { ?> <?php echo $_smarty_tpl->tpl_vars['d']->value['currency_symbol'];
											...
											<?php } else { ?>
											<tr class="h4">
													<td class="fontsize_14" colspan="2"><?php echo $_smarty_tpl->tpl_vars['_L']->value['Grand Total'];?>
</td>
													<td class="fontsize_14  text-right amount" data-a-sign="<?php if ($_smarty_tpl->tpl_vars['d']->value['currency_symbol'] == '') {?> <?php echo $_smarty_tpl->tpl_vars['_c']->value['currency_code'];?>
 <?php } else { ?> <?php echo $_smarty_tpl->tpl_vars['d']->value['currency_symbol'];
}?> "><?php echo $_smarty_tpl->tpl_vars['d']->value['subtotal'];?>
</td>
											</tr>
