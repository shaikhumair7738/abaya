<?php
/* Smarty version 3.1.30, created on 2023-10-25 17:49:36
  from "/home2/mbillsin/public_html/alabaya/ui/theme/ibilling/ajax.contact-balance-sheet-vendor.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_653907d87a5485_37454979',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '12a8bf4e3e7226d2859b86dec538bbce2972a441' => 
    array (
      0 => '/home2/mbillsin/public_html/alabaya/ui/theme/ibilling/ajax.contact-balance-sheet-vendor.tpl',
      1 => 1696424035,
      2 => 'file',
    ),
  ),
...
function content_653907d87a5485_37454979 (Smarty_Internal_Template $_smarty_tpl) {
?>
    ...
    <div class="row">
        ...
        <table id="example" class="display" style="width:100%">
                ...
                <tbody>
                    ...
                    <!---->
                    <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['creditStock']->value, 'ds');
if ($_from !== null) {
foreach ($_from as $_smarty_tpl->tpl_vars['ds']->value) {
?>
                    <tr style="background: #fcf8e3">
                        <td data-search="<?php echo date('dM,Y',strtotime($_smarty_tpl->tpl_vars['ds']->value['timestamp']));?>
" data-order="<?php echo $_smarty_tpl->tpl_vars['ds']->value['timestamp'];?>
" style="background-color: inherit;">
                            <?php echo date($_smarty_tpl->tpl_vars['_c']->value['df'],strtotime($_smarty_tpl->tpl_vars['ds']->value['timestamp']));?>

                        </td>
                        <td><?php echo $_smarty_tpl->tpl_vars['ds']->value['stock'];?>
 stock added of product <?php echo $_smarty_tpl->tpl_vars['ds']->value['item_id'];?>
 (per stock price : <?php echo $_smarty_tpl->tpl_vars['ds']->value['purchase_price'];?>
)</td>
                        <td class="text-right dr"><?php echo $_smarty_tpl->tpl_vars['ds']->value['stock']*$_smarty_tpl->tpl_vars['ds']->value['purchase_price'];?>
</td>  
                        <td class="text-right cr">0</td> 
                        <td class="text-right bl">0</td>                                             
                        <td>
                            <a target="_blank" href="-">-</a> <!--<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
-->
                        </td>
                    </tr>
                    <?php
...
?>
                    ...
                    <!---->
                    <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['debitStock']->value, 'ds');
if ($_from !== null) {
foreach ($_from as $_smarty_tpl->tpl_vars['ds']->value) {
?>
...
" style="background-color: inherit;">
                        ...
                        <td><?php echo $_smarty_tpl->tpl_vars['ds']->value['stock'];?>
 stock removed of product <?php echo $_smarty_tpl->tpl_vars['ds']->value['item_id'];?>
 (per stock price : <?php echo $_smarty_tpl->tpl_vars['ds']->value['purchase_price'];?>
)</td>
                        <td class="text-right dr">0</td>  
                        <td class="text-right cr"><?php echo $_smarty_tpl->tpl_vars['ds']->value['stock']*$_smarty_tpl->tpl_vars['ds']->value['purchase_price'];?>
</td> 
                        <td class="text-right bl">0</td>                                             
                        <td>
                            <a target="_blank" href="-">-</a> <!--<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
...
?>
                    ...
                    <!---->
                    <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['expenseTr']->value, 'ds');
if ($_from !== null) {
foreach ($_from as $_smarty_tpl->tpl_vars['ds']->value) {
?>
                    <tr style="background: #d9edf7">
                        <td data-search="<?php echo date('dM,Y',strtotime($_smarty_tpl->tpl_vars['ds']->value['date']));?>
" data-order="<?php echo $_smarty_tpl->tpl_vars['ds']->value['datetime'];?>
" style="background-color: inherit;">
                            <?php echo date($_smarty_tpl->tpl_vars['_c']->value['df'],strtotime($_smarty_tpl->tpl_vars['ds']->value['date']));?>

                        </td>
                        <td>Desc : <?php echo $_smarty_tpl->tpl_vars['ds']->value['description'];?>
<br>Category : <?php echo $_smarty_tpl->tpl_vars['ds']->value['category'];?>
<br>Method : <?php echo $_smarty_tpl->tpl_vars['ds']->value['method'];?>
</td>
                        <td class="text-right dr">0</td>  
                        <td class="text-right cr"><?php echo $_smarty_tpl->tpl_vars['ds']->value['amount'];?>
</td> 
                        <td class="text-right bl">0</td>                                             
                        <td>
...
<hr>
    ...
    <div style="margin-bottom: 10px;font-size: 16px;">
        <b>Credit :</b>
        <span style="font-size: 16px;" class="label label-info amount g_credit" data-a-dec="<?php echo $_smarty_tpl->tpl_vars['_c']->value['dec_point'];?>
...
" data-v-min="-999999999" data-v-max="999999999"></span>    
    </div>
    
    <div style="margin-bottom: 10px;font-size: 16px;">
        <b>Debit :</b>
        <span style="font-size: 16px;" class="label label-primary amount g_debit" data-a-dec="<?php echo $_smarty_tpl->tpl_vars['_c']->value['dec_point'];?>
" data-a-sep="<?php echo $_smarty_tpl->tpl_vars['_c']->value['thousands_sep'];?>
" data-a-pad="<?php echo $_smarty_tpl->tpl_vars['_c']->value['currency_decimal_digits'];?>
" data-p-sign="<?php echo $_smarty_tpl->tpl_vars['_c']->value['currency_symbol_position'];?>
" data-a-sign="<?php echo $_smarty_tpl->tpl_vars['_c']->value['currency_code'];?>
...
" data-v-min="-999999999" data-v-max="999999999"></span>    
    ...
    <div style="margin-bottom: 10px;font-size: 16px;">
        <b>Balance :</b>
        <span style="font-size: 16px;" class="label label-warning amount g_balance" data-a-dec="<?php echo $_smarty_tpl->tpl_vars['_c']->value['dec_point'];?>
" data-a-sep="<?php echo $_smarty_tpl->tpl_vars['_c']->value['thousands_sep'];?>
" data-a-pad="<?php echo $_smarty_tpl->tpl_vars['_c']->value['currency_decimal_digits'];?>
" data-p-sign="<?php echo $_smarty_tpl->tpl_vars['_c']->value['currency_symbol_position'];?>
" data-a-sign="<?php echo $_smarty_tpl->tpl_vars['_c']->value['currency_code'];?>
                    ...
                    exportOptions: {
                        ...
                        format: {
                            body: function ( data, row, column, node ) {
                                return data.replace(/<br\s*\/<?php echo '?>';?>/ig, "\r\n");
                            }
                        }                        
                    }                    
                },
...
function exportTitle(type)
{
    ...
    var company_name = "<?php echo $_smarty_tpl->tpl_vars['company']->value['account'];?>
";
    var company_addr = "<?php echo $_smarty_tpl->tpl_vars['company']->value['address'];?>
";
