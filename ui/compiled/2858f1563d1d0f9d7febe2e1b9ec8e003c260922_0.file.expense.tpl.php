<?php
/* Smarty version 3.1.30, created on 2022-04-11 09:46:48
  from "/home4/makentin/public_html/bill/ui/theme/ibilling/expense.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_6253abb04868f9_13777531',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '2858f1563d1d0f9d7febe2e1b9ec8e003c260922' => 
    array (
      0 => '/home4/makentin/public_html/bill/ui/theme/ibilling/expense.tpl',
      1 => 1649650575,
      2 => 'file',
    ),
  ),
...
function content_6253abb04868f9_13777531 (Smarty_Internal_Template $_smarty_tpl) {
?>
<style>
    .select2-dropdown {
    height: 250px;
...
" name="date" id="date" datepicker data-date-format="yyyy-mm-dd" data-auto-close="true">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <h4 class="a_toggle"><a href="#" id="a_toggle"><?php echo $_smarty_tpl->tpl_vars['_L']->value['Advanced'];?>
</a> </h4>
                        </div>
                    </div>
                    <div id="a_hide">
...
?>
                        ...
                        <div class="form-group">
                            ...
                            <label for="payee" class="col-sm-3 control-label">Customer</label>
                            <div class="col-sm-9">
...
"><?php echo $_smarty_tpl->tpl_vars['ps']->value['account'];?>
 / <?php echo $_smarty_tpl->tpl_vars['ps']->value['company'];?>
 <?php if ($_smarty_tpl->tpl_vars['ps']->value['email'] != '') {?> / <?php echo $_smarty_tpl->tpl_vars['ps']->value['email'];
}?></option>
                                    <?php
}
}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <select id="vendor_id" name="vendor_id" class="form-control">
                                    ...
                                    <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['v']->value, 'ps');
if ($_from !== null) {
foreach ($_from as $_smarty_tpl->tpl_vars['ps']->value) {
?>
                                        <option value="<?php echo $_smarty_tpl->tpl_vars['ps']->value['id'];?>
