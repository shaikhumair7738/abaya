<?php
/* Smarty version 3.1.30, created on 2017-08-16 17:26:26
  from "F:\wamp64\www\mbilling\ui\theme\ibilling\edit_invoice_v2.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_599432eaaa3451_58045071',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'e04d67dfb9d6007533b300e29c1165f015d93eab' => 
    array (
      0 => 'F:\\wamp64\\www\\mbilling\\ui\\theme\\ibilling\\edit_invoice_v2.tpl',
      1 => 1502884564,
      2 => 'file',
    ),
  ),
...
function content_599432eaaa3451_58045071 (Smarty_Internal_Template $_smarty_tpl) {
if (!is_callable('smarty_modifier_replace')) require_once 'F:\\wamp64\\www\\mbilling\\vendor\\smarty\\smarty\\libs\\plugins\\modifier.replace.php';
...
?>
                                <tr> <td class="number"><?php echo $_smarty_tpl->tpl_vars['item']->value['itemcode'];?>
...
" id="p_id"></td>
								<td><input type="text" class="form-control item_name" name="desc[]" value="<?php echo $_smarty_tpl->tpl_vars['item']->value['description'];?>
" /> </td>
								<td><input type="text" class="form-control weight" value="<?php echo $_smarty_tpl->tpl_vars['item']->value['weight'];?>
" name="weight[]" required>
								<input type="hidden" class="" value="<?php echo $_smarty_tpl->tpl_vars['item']->value['weight'];?>
" name="edit_weight[]">
								<span class="error_msg"></span>
								</td>
								<td><input type="text" class="form-control height" name="height[]" value="<?php echo $_smarty_tpl->tpl_vars['item']->value['height'];?>
" required>
								<input type="hidden" class="" value="<?php echo $_smarty_tpl->tpl_vars['item']->value['height'];?>
" name="edit_height[]">
								<span class="error_msg1"></span>
								</td>
								<td><input type="text" class="form-control item_price" name="amount[]" value="<?php if (($_smarty_tpl->tpl_vars['_c']->value['dec_point']) == ',') {
echo smarty_modifier_replace($_smarty_tpl->tpl_vars['item']->value['amount'],'.',',');
} else {
echo $_smarty_tpl->tpl_vars['item']->value['amount'];
}?>" readonly></td> 
								<td class="ltotal"><input type="text" class="form-control lvtotal" name="total[]" value="<?php if (($_smarty_tpl->tpl_vars['_c']->value['dec_point']) == ',') {
ob_start();
echo $_smarty_tpl->tpl_vars['item']->value['amt_total'];
...
" <?php if ($_smarty_tpl->tpl_vars['tax']->value['id'] == ($_smarty_tpl->tpl_vars['item']->value['taxed'])) {?>selected="selected" <?php }?>><?php echo $_smarty_tpl->tpl_vars['tax']->value['name'];?>
...
?>
                    ...
                    <button type="button" class="btn btn-primary" id="item-add"><i
                                class="fa fa-search"></i> <?php echo $_smarty_tpl->tpl_vars['_L']->value['Add Product'];?>
</button>
