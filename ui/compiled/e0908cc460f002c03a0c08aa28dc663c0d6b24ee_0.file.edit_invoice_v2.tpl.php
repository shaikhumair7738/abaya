<?php
/* Smarty version 3.1.30, created on 2017-10-16 18:19:58
  from "F:\wamp64\www\makbilling\ui\theme\ibilling\edit_invoice_v2.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_59e4aaf6be8be2_88393010',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'e0908cc460f002c03a0c08aa28dc663c0d6b24ee' => 
    array (
      0 => 'F:\\wamp64\\www\\makbilling\\ui\\theme\\ibilling\\edit_invoice_v2.tpl',
      1 => 1507805104,
      2 => 'file',
    ),
  ),
...
function content_59e4aaf6be8be2_88393010 (Smarty_Internal_Template $_smarty_tpl) {
if (!is_callable('smarty_modifier_replace')) require_once 'F:\\wamp64\\www\\makbilling\\vendor\\smarty\\smarty\\libs\\plugins\\modifier.replace.php';
...
?>
									<tr class="tr_clone"> 
										<td><span id="codei_0" name="i_code[]"><?php echo $_smarty_tpl->tpl_vars['item']->value['itemcode'];?>
												...
												<input type="hidden" class="form-control invitemid" value="<?php echo $_smarty_tpl->tpl_vars['item']->value['id'];?>
" name="invitemid[]"></td> 
...
?>
													<option value="<?php echo $_smarty_tpl->tpl_vars['prod']->value['id'];?>
" <?php if ($_smarty_tpl->tpl_vars['prod']->value['name'] == ($_smarty_tpl->tpl_vars['item']->value['description'])) {?>selected="selected" <?php }?>><?php echo $_smarty_tpl->tpl_vars['prod']->value['name'];?>
</option>
												<?php
}
}
...
echo $_smarty_tpl->tpl_vars['item']->value['amount'];
										...
										<td class="ltotal"><input type="text" class="form-control lvtotal" readonly="" name="total[]" value="<?php if (($_smarty_tpl->tpl_vars['_c']->value['dec_point']) == ',') {
ob_start();
...
">
 ...
 :</strong></td>
									<td id="sub_total" class="amount"><?php echo $_smarty_tpl->tpl_vars['d']->value['subtotal'];?>
</td>
							</tr>
 ...
 :</strong></td>
									<td id="taxtotal" class="amount"><?php echo $_smarty_tpl->tpl_vars['d']->value['tax'];?>
</td>
							</tr>
							<tr>
									<td><strong><?php echo $_smarty_tpl->tpl_vars['_L']->value['TOTAL'];?>
 :</strong></td>
									<td id="total" class="amount"><?php echo $_smarty_tpl->tpl_vars['d']->value['total'];?>
</td>
							</tr>
						</tbody>
					</table>
